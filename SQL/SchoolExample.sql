...
-- Student names woho have not yet taken any classes

SELECT name FROM students WHERE sid NOT IN (SELECT studentID FROM grades);

-- Select student names who have taken atleast one class
SELECT * FROM students WHERE sid IN (SELECT studentID FROM grades);

-- Names of teachers that have not yet any classes
...
-- Names of teacher who have taught Biology
